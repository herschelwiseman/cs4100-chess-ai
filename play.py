...
def selectmove(depth):
    try:
        move = chess.polyglot.MemoryMappedReader("C:/Users/Herschel/PycharmProjects/ChessAi/books/human.bin").weighted_choice(board).move
...
def stockfish():
    #stockfish = Stockfish(path="/Users/Herschel/PyCharmProjects/ChessAi/stockfish/stockfish-9-64")
